...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_web3__ = __webpack_require__(6);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__web3__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__build_TicketsFactory_json__ = __webpack_require__(7);
...
// EXTERNAL MODULE: ./Ethereum/factory.js
...
// CONCATENATED MODULE: ./Components/BackNav.js
...
var BackNav_BackNav = function (_Component) {
...
/* harmony default export */ var Components_BackNav = (BackNav_BackNav);
// CONCATENATED MODULE: ./pages/new.js


var new__createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

function _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step("next", value); }, function (err) { step("throw", err); }); } } return step("next"); }); }; }

function new__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function new__possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }

function new__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
...
var new_NewTicket = function (_Component) {
  new__inherits(NewTicket, _Component);

  function NewTicket(props) {
    new__classCallCheck(this, NewTicket);

    var _this = new__possibleConstructorReturn(this, (NewTicket.__proto__ || Object.getPrototypeOf(NewTicket)).call(this, props));
  ...
  new__createClass(NewTicket, [{
    key: 'sellTicket',
    value: function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regenerator__default.a.mark(function _callee(evt) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 7:
                ...
                _context.next = 10;
                return factory["a" /* default */].methods.createTicket(price, info).send({
                  from: accounts[0]
                });
    ...
    value: function render() {
      ...
      return external__react__default.a.createElement(
        'div',
        null,
        external__react__default.a.createElement(Components_BackNav, null),
        external__react__default.a.createElement(
          'div',
          { className: 'outerForm' },
          external__react__default.a.createElement(
          ...
          external__react__default.a.createElement(
            'form',
            { className: 'form', id: 'newTicketForm', onSubmit: this.sellTicket },
            external__react__default.a.createElement(
              'div',
              null,
              external__react__default.a.createElement(
              ...
              external__react__default.a.createElement('input', { name: 'name', type: 'text', required: true, placeholder: 'Name' })
            ),
            external__react__default.a.createElement(
              'div',
              null,
            ...
            external__react__default.a.createElement(
              ...
              external__react__default.a.createElement('input', { name: 'venue', type: 'text', required: true, placeholder: 'venue' })
            ),
            external__react__default.a.createElement(
              'div',
              null,
              ...
              external__react__default.a.createElement('input', { name: 'city', type: 'text', required: true, placeholder: 'city' })
            ),
            external__react__default.a.createElement(
              'div',
              null,
              ...
              external__react__default.a.createElement('input', { name: 'price', type: 'text', required: true, placeholder: '00000000' })
            ),
            external__react__default.a.createElement(
              'div',
              null,
        ...
        !this.state.loading ? null : external__react__default.a.createElement(
          'div',
          { className: 'loading' },
          'This Will Take 15-30 Seconds Be Patient!'
        ),
        this.state.error === '' ? null : external__react__default.a.createElement(
          'div',
          { className: 'error' },
          external__react__default.a.createElement(
            'h2',
...
/* harmony default export */ var pages_new = __webpack_exports__["default"] = (new_NewTicket);
